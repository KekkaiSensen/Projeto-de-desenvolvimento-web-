...
<body>
    ...
    <nav class="actions">
      ...
      <div style="display: flex; gap: 30px; align-items: center;">
        ...
        <a href="tela_carrinho.php" style="display: flex; align-items: center; gap: 5px;">
          Carrinho <img src="assets/imagens/carrinho invertido.png" alt="" style="width: 20px; height: 20px;">
        </a>
  ...
  <main class="produto-container" data-id="<?php echo $produto['id']; ?>" data-title="<?php echo htmlspecialchars($produto['nome']); ?>" data-price="<?php echo htmlspecialchars($preco_final); ?>" data-img="<?php echo htmlspecialchars($produto['imagem_url']); ?>" data-fornecedor="<?php echo $produto['usuario_id'] ?? 6; ?>">
