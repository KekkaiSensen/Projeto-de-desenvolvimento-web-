...
// [FIX] Substitui quebras de linha literais "\n" por quebras reais
$descricao_completa = str_replace(['\n', '\\n'], "\n", $descricao_completa);
...
// [FIX] Deduplicar imagens para a galeria
$imagens_galeria = [];
if (!empty($produto['imagem_url'])) {
  $imagens_galeria[] = $produto['imagem_url'];
}
foreach ($imagens_secundarias as $img) {
  if (!empty($img['url_imagem']) && !in_array($img['url_imagem'], $imagens_galeria)) {
    $imagens_galeria[] = $img['url_imagem'];
  }
}
      ...
      <
        ...
        <
          title> Página do Produto < /title>
            <
              link rel="stylesheet"
              href="assets/estilos/style.css" />
              <
                link rel="stylesheet"
                href="assets/estilos/notifications.css">
                <
                  link rel="stylesheet"
                  href="assets/estilos/estilo_carrinho.css">
                  <
                    link rel="stylesheet"
                    href="assets/estilos/estilo_produto.css">
                              ...
                              <
                                ...
                                <
                                  ...
                                  <
                                    ...
                                    <
                                      img src="assets/imagens/exemplo-logo.png"
                                      alt=""
                                      ...
                                      <
                                        ...
                                        <
                                          ...
                                          <
                                            ...
                                            method="GET"
                                            style="position: relative; width: 600px; max-width: 100%;">
                                            <
                                              input type="search"
                                              id="pesquisa"
                                              name="q"
                                                                  ...
                                                                  <
                                                                    a href="tela_cadastro.html"> Crie a sua conta < /a>
                                                                      <
                                                                        ...
                                                                        <?php endif; ?>
                                                                        <
                                                                          a href="tela_carrinho.php"
                                                                          style="display: flex; align-items: center; gap: 5px;">
                                                                          Carrinho <
                                                                            img src="assets/imagens/carrinho invertido.png"
                                                                            alt=""
                                                                              ...
                                                                              <?php if ($usuario_logado): ?>
                                                                                <
                                                                                  ...
                                                                                  <
                                                                                    ...
                                                                                    <
                                                                                      svg class="notification-bell-icon"
                                                                                                        ...
                                                                                                        <
                                                                                                          span> Notificações < /span>
                                                                                                            <
                                                                                                              ...
                                                                                                              class="mark-all-read"> Marcar todas como lidas < /span>
                                                                                                                <
                                                                                                                  /div>
                                                                                                                  <
                                                                                                                              ...
                                                                                                                              <
                                                                                                                                ...
                                                                                                                                <
                                                                                                                                  ...
                                                                                                                                  <div class="thumbnails">
                                                                                                                                    <img src="<?php echo htmlspecialchars($produto['imagem_url']); ?>" alt="Thumb Principal" class="thumb-img active" onmouseover="mudarImagem(this)">
                                                                                                                                    <?php foreach ($imagens_galeria as $imgUrl): ?>
                                                                                                                                      <?php if ($imgUrl == $produto['imagem_url']) continue; ?>
                                                                                                                                      <img src="<?php echo htmlspecialchars($imgUrl); ?>" alt="Thumb" class="thumb-img" onmouseover="mudarImagem(this)">
                                                                                                                                    <?php endforeach; ?>
                                                                                                                                  </div>
                                                                                                                                  ...
                                                                                                                                  <?php if (false): ?>
                                                                                                                                    <div class="old-gallery-commented-out">
                                                                                                                                      <
                                                                                                                                        img src="<?php echo htmlspecialchars($produto['imagem_url']); ?>"
                                                                                                                                        alt="Thumb 1"
                                                                                                                                        class="thumb-img active"
                                                                                                                                        onmouseover="mudarImagem(this)">
                                                                                                                                        <?php foreach ($imagens_secundarias as $img): ?> <
                                                                                                                                            img src="<?php echo htmlspecialchars($img['url_imagem']); ?>"
                                                                                                                                            alt="Thumb"
                                                                                                                                            class="thumb-img"
                                                                                                                                            onmouseover="mudarImagem(this)">
                                                                                                                                          <?php endforeach; ?> <
                                                                                                                                                                          ...
                                                                                                                                                                          <
                                                                                                                                                                            ...
                                                                                                                                                                            <
                                                                                                                                                                              ...
                                                                                                                                                                              <
                                                                                                                                                                                ...
                                                                                                                                                                                id="produto-titulo"> <?php echo htmlspecialchars($produto['nome']); ?> < /h1>

                                                                                                                                                                                  <
                                                                                                                                                                                    div class="produto-preco">
                                                                                                                                                                                    <?php if ($tem_desconto): ?> <
                                                                                                                                                                                        span class="old"
                                                                                                                                                                                        id="produto-preco-antigo"> <?php echo $preco_antigo_formatado; ?> < /span>
                                                                                                                                                                                        <?php endif; ?>
                                                                                                                                                                                        <
                                                                                                                                                                                          span class="price"
                                                                                                                                                                                          id="produto-preco"> <?php echo $preco_final_formatado; ?> < /span>
                                                                                                                                                                                            <?php if ($tem_desconto): ?>
                                                                                                                                                                                              <
                                                                                                                                                                                                span class="badge"
                                                                                                                                                                                                id="produto-badge"> <?php echo $badge_texto; ?> < /span>
                                                                                                                                                                                                <?php endif; ?>
                                                                                                                                                                                                <
                                                                                                                                                                                                  /div>
                                                                                                                                                                                                  <
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      <
                                                                                                                                                                                                        span class="star"
                                                                                                                                                                                                        data - value="1"> & #9734;</span>
                                                                                                                                                                                                        <span class="star"
                                                                                                                                                                                                          data - value="2"> & #9734;</span>
                                                                                                                                                                                                        <span class="star"
                                                                                                                                                                                                          data - value="3"> & #9734;</span>
                                                                                                                                                                                                        <span class="star"
                                                                                                                                                                                                          data - value="4"> & #9734;</span>
                                                                                                                                                                                                        <span class="star"
                                                                                                                                                                                                          data - value="5"> & #9734;</span>
                                                                                                                                    </div>
                                                                                                                                    ...
                                                                                                                                    <label class="label-quantidade"> Quantidade: < /label>
                                                                                                                                        <
                                                                                                                                          ...
                                                                                                                                          <
                                                                                                                                            ...
                                                                                                                                            style="margin-right: 0; justify-content: flex-start;">
                                                                                                                                            <
                                                                                                                                              button type="button"
                                                                                                                                              onclick="alterarContador(-1)"> - < /button>
                                                                                                                                                <
                                                                                                                                                  div id="contador-numero"
                                                                                                                                                  class="contador-numero"
                                                                                                                                                  style="color: black; font-weight:500;"> 1 < /div>
                                                                                                                                                    <
                                                                                                                                                      button type="button"
                                                                                                                                                      onclick="alterarContador(1)"> + < /button>
                                                                                                                                                        <
                                                                                                                                                            ...
                                                                                                                                                            span class="qtd-disponivel"> (<?php echo $produto['estoque']; ?> disponíveis) < /span>
                                                                                                                                                              <
                                                                                                                                                                ...
                                                                                                                                                                <
                                                                                                                                                                  ...
                                                                                                                                                                  <
                                                                                                                                                                    button class="btn-acao btn-comprar"
                                                                                                                                                                    id="btn-comprar"> Comprar agora < /button>
                                                                                                                                                                      <
                                                                                                                                                                        button class="btn-acao btn-adicionar"
                                                                                                                                                                        id="btn-adicionar-carrinho"> Adicionar ao carrinho < /button>
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      <
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        <
                                                                                                                                                                                                                                          h2> Opiniões do produto < /h2>
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            <?php if ($usuario_logado): ?> <
                                                                                                                                                                                                                                                div class="opiniao-form-container"
                                                                                                                                                                                                                                                id="opiniao-form-container">

                                                                                                                                                                                                                                                <
                                                                                                                                                                                                                                                  div class="opiniao-form">
                                                                                                                                                                                                                                                  <
                                                                                                                                                                                                                                                    textarea id="opiniao-textarea"
                                                                                                                                                                                                                                                    placeholder="Escreva sua opinião aqui...">
                                                                                                                                                                                                                                                    < /textarea>
                                                                                                                                                                                                                                                      <
                                                                                                                                                                                                                                                        button type="button"
                                                                                                                                                                                                                                                        class="btn-acao btn-comprar"
                                                                                                                                                                                                                                                        id="btn-enviar-opiniao"> Enviar Comentário < /button>
                                                                                                                                                                                                                                                          <
                                                                                                                                                                                                                                                            /div>
                                                                                                                                                                                                                                                            <
                                                                                                                                                                                                                                                              /div>
                                                                                                                                                                                                                                                            <?php else: ?>
                                                                                                                                                                                                                                                              <
                                                                                                                                                                                                                                                                p> Você precisa < a href="tela_login.html"
                                                                                                                                                                                                                                                                  style="color: #007bff; text-decoration: none;"> fazer login < /a> para avaliar este produto.</p>
                                                                                                                                                                                                                                                                  <?php endif; ?>
                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                          <
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            <?php if ($minha_avaliacao): ?>
                                                                                                                                                                                                                                                                              <
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                id="minha-opiniao-<?php echo $minha_avaliacao['id']; ?>">
                                                                                                                                                                                                                                                                                <
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        span class="opiniao-data"> <?php echo date('d/m/Y', strtotime($minha_avaliacao['data_avaliacao'])); ?> < /span>
                                                                                                                                                                                                                                                                                          <
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            <
                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                              ?> <
                                                                                                                                                                                                                                                                                                  span class="star <?php echo ($i <= $minha_avaliacao['nota']) ? 'filled' : ''; ?>"> & #9733;</span>
                                                                                                                                                                                                                                                                                                <?php endfor; ?>
                                                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                <button type="button"
                                                                                                                                                                                                                                                                                                  class="btn-link-excluir"
                                                                                                                                                                                                                                                                                                  onclick="excluirAvaliacao(<?php echo $minha_avaliacao['id']; ?>)">
                                                                                                                                                                                                                                                                                                  Excluir avaliação <
                                                                                                                                                                                                                                                                                                    /button>
                                                                                                                                                                                                                                                                                                    <
                                                                                                                                                                                                                                                                                                      /div>
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    <?php foreach ($outras_avaliacoes as $avaliacao): ?>
                                                                                                                                                                                                                                                                                                      <
                                                                                                                                                                                                                                                                                                        div class="opiniao-item"
                                                                                                                                                                                                                                                                                                        id="opiniao-<?php echo $avaliacao['id']; ?>">
                                                                                                                                                                                                                                                                                                        <
                                                                                                                                                                                                                                                                                                          div class="opiniao-header">
                                                                                                                                                                                                                                                                                                          <
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                span class="opiniao-data"> <?php echo date('d/m/Y', strtotime($avaliacao['data_avaliacao'])); ?> < /span>
                                                                                                                                                                                                                                                                                                                  <
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    <
                                                                                                                                                                                                                                                                                                                      div class="opiniao-estrelas">
                                                                                                                                                                                                                                                                                                                      <?php for ($i = 1; $i <= 5; $i++): ?> <
                                                                                                                                                                                                                                                                                                                          span class="star <?php echo ($i <= $avaliacao['nota']) ? 'filled' : ''; ?>"> & #9733;</span>
                                                                                                                                                                                                                                                                                                                        <?php endfor; ?>
                                                                                                                                                                                                                                                                                                                        </div>
