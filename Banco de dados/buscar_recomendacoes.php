...
// ===================================================================
// === 1. SQL DE FALLBACK (MODIFICADA) ===
// SQL de fallback: Se o usuário não tiver histórico ou não estiver logado,
// mostra produtos aleatórios, agora incluindo as avaliações.
// ===================================================================
$sql_fallback = "SELECT 
...
try {
    ...
    try {
        // ===================================================================
        // === 3. SQL DE FALLBACK (DENTRO DO CATCH) ===
        // A consulta SQL aqui é a mesma do $sql_fallback
        // ===================================================================
        $stmt_fallback = $pdo->prepare($sql_fallback);
        $stmt_fallback->execute();
        $recomendacoes = $stmt_fallback->fetchAll(PDO::FETCH_ASSOC);
